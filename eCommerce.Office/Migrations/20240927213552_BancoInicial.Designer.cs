...
namespace eCommerce.Office.Migrations
{
    ...
    [Migration("20240927213552_BancoInicial")]
            ...
            modelBuilder.Entity("eCommerce.Office.Models.ColaboradorSetor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ColaboradorId = 1,
                            SetorId = 1,
                            Criado = new DateTimeOffset(new DateTime(2024, 9, 27, 18, 35, 52, 36, DateTimeKind.Unspecified).AddTicks(670), new TimeSpan(0, -3, 0, 0, 0))
                        },
                        new
                        {
                            ColaboradorId = 6,
                            SetorId = 1,
                            Criado = new DateTimeOffset(new DateTime(2024, 9, 27, 18, 35, 52, 36, DateTimeKind.Unspecified).AddTicks(716), new TimeSpan(0, -3, 0, 0, 0))
                        },
                        new
                        {
                            ColaboradorId = 5,
                            SetorId = 2,
                            Criado = new DateTimeOffset(new DateTime(2024, 9, 27, 18, 35, 52, 36, DateTimeKind.Unspecified).AddTicks(718), new TimeSpan(0, -3, 0, 0, 0))
                        },
                        new
                        {
                            ColaboradorId = 4,
                            SetorId = 2,
                            Criado = new DateTimeOffset(new DateTime(2024, 9, 27, 18, 35, 52, 36, DateTimeKind.Unspecified).AddTicks(719), new TimeSpan(0, -3, 0, 0, 0))
                        },
                        new
                        {
                            ColaboradorId = 7,
                            SetorId = 3,
                            Criado = new DateTimeOffset(new DateTime(2024, 9, 27, 18, 35, 52, 36, DateTimeKind.Unspecified).AddTicks(721), new TimeSpan(0, -3, 0, 0, 0))
                        },
                        new
                        {
                            ColaboradorId = 2,
                            SetorId = 4,
                            Criado = new DateTimeOffset(new DateTime(2024, 9, 27, 18, 35, 52, 36, DateTimeKind.Unspecified).AddTicks(722), new TimeSpan(0, -3, 0, 0, 0))
                        },
                        new
                        {
                            ColaboradorId = 3,
                            SetorId = 4,
                            Criado = new DateTimeOffset(new DateTime(2024, 9, 27, 18, 35, 52, 36, DateTimeKind.Unspecified).AddTicks(723), new TimeSpan(0, -3, 0, 0, 0))
                        });
                });
