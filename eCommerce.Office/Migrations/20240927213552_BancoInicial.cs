    ...
    public partial class BancoInicial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTimeOffset(new DateTime(2024, 9, 27, 18, 35, 52, 36, DateTimeKind.Unspecified).AddTicks(670), new TimeSpan(0, -3, 0, 0, 0)) },
                    { 2, 4, new DateTimeOffset(new DateTime(2024, 9, 27, 18, 35, 52, 36, DateTimeKind.Unspecified).AddTicks(722), new TimeSpan(0, -3, 0, 0, 0)) },
                    { 3, 4, new DateTimeOffset(new DateTime(2024, 9, 27, 18, 35, 52, 36, DateTimeKind.Unspecified).AddTicks(723), new TimeSpan(0, -3, 0, 0, 0)) },
                    { 4, 2, new DateTimeOffset(new DateTime(2024, 9, 27, 18, 35, 52, 36, DateTimeKind.Unspecified).AddTicks(719), new TimeSpan(0, -3, 0, 0, 0)) },
                    { 5, 2, new DateTimeOffset(new DateTime(2024, 9, 27, 18, 35, 52, 36, DateTimeKind.Unspecified).AddTicks(718), new TimeSpan(0, -3, 0, 0, 0)) },
                    { 6, 1, new DateTimeOffset(new DateTime(2024, 9, 27, 18, 35, 52, 36, DateTimeKind.Unspecified).AddTicks(716), new TimeSpan(0, -3, 0, 0, 0)) },
                    { 7, 3, new DateTimeOffset(new DateTime(2024, 9, 27, 18, 35, 52, 36, DateTimeKind.Unspecified).AddTicks(721), new TimeSpan(0, -3, 0, 0, 0)) }
                });
